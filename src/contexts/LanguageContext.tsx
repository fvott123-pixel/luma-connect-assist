...
export const translations: Translations = {
  ...
  "prepare.titleField": { EN: "Title", AR: "اللقب", NP: "शीर्षक", IT: "Titolo", VI: "Danh xưng" },
  "prepare.selectTitle": { EN: "Select title", AR: "اختر اللقب", NP: "शीर्षक छान्नुहोस्", IT: "Seleziona titolo", VI: "Chọn danh xưng" },
  "prepare.firstName": { EN: "First Name", AR: "الاسم الأول", NP: "पहिलो नाम", IT: "Nome", VI: "Tên" },
  "prepare.enterFirstName": { EN: "Enter first name", AR: "أدخل الاسم الأول", NP: "पहिलो नाम प्रविष्ट गर्नुहोस्", IT: "Inserisci il nome", VI: "Nhập tên" },
  "prepare.surname": { EN: "Surname", AR: "اسم العائلة", NP: "थर", IT: "Cognome", VI: "Họ" },
  "prepare.enterSurname": { EN: "Enter surname", AR: "أدخل اسم العائلة", NP: "थर प्रविष्ट गर्नुहोस्", IT: "Inserisci il cognome", VI: "Nhập họ" },
  "prepare.gender": { EN: "Gender", AR: "الجنس", NP: "लिङ्ग", IT: "Genere", VI: "Giới tính" },
  "prepare.selectGender": { EN: "Select gender", AR: "اختر الجنس", NP: "लिङ्ग छान्नुहोस्", IT: "Seleziona genere", VI: "Chọn giới tính" },
  "prepare.suburb": { EN: "Suburb", AR: "الضاحية", NP: "उपनगर", IT: "Sobborgo", VI: "Vùng ngoại ô" },
  "prepare.enterSuburb": { EN: "Enter suburb", AR: "أدخل الضاحية", NP: "उपनगर प्रविष्ट गर्नुहोस्", IT: "Inserisci sobborgo", VI: "Nhập vùng ngoại ô" },
  "prepare.state": { EN: "State", AR: "الولاية", NP: "राज्य", IT: "Stato", VI: "Bang" },
  "prepare.selectState": { EN: "Select state", AR: "اختر الولاية", NP: "राज्य छान्नुहोस्", IT: "Seleziona stato", VI: "Chọn bang" },
  "prepare.postcode": { EN: "Postcode", AR: "الرمز البريدي", NP: "पोस्टकोड", IT: "CAP", VI: "Mã bưu điện" },
  "prepare.email": { EN: "Email", AR: "البريد الإلكتروني", NP: "इमेल", IT: "Email", VI: "Email" },
  "prepare.enterEmail": { EN: "Enter email", AR: "أدخل البريد الإلكتروني", NP: "इमेल प्रविष्ट गर्नुहोस्", IT: "Inserisci email", VI: "Nhập email" },
  "prepare.enterStreet": { EN: "Enter street address", AR: "أدخل عنوان الشارع", NP: "सडकको ठेगाना प्रविष्ट गर्नुहोस्", IT: "Inserisci indirizzo", VI: "Nhập địa chỉ đường" },
  "prepare.medicareIntro": { EN: "I'll help you pre-fill the Medicare enrolment form (MS004). Enter your details below.", AR: "سأساعدك في ملء نموذج تسجيل Medicare (MS004). أدخل بياناتك أدناه.", NP: "म तपाईंलाई Medicare दर्ता फारम (MS004) भर्न मद्दत गर्छु। तलको विवरण प्रविष्ट गर्नुहोस्।", IT: "Ti aiuterò a compilare il modulo Medicare (MS004). Inserisci i tuoi dati qui sotto.", VI: "Tôi sẽ giúp bạn điền sẵn biểu mẫu đăng ký Medicare (MS004). Nhập thông tin bên dưới." },
  "prepare.prefillMedicare": { EN: "Download pre-filled MS004 form →", AR: "تحميل نموذج MS004 المعبأ →", NP: "पूर्व-भरिएको MS004 फारम डाउनलोड गर्नुहोस् →", IT: "Scarica modulo MS004 precompilato →", VI: "Tải biểu mẫu MS004 đã điền →" },
  "prepare.prefillSuccess": { EN: "Your pre-filled Medicare form has been downloaded!", AR: "تم تحميل نموذج Medicare المعبأ!", NP: "तपाईंको पूर्व-भरिएको Medicare फारम डाउनलोड भयो!", IT: "Il modulo Medicare precompilato è stato scaricato!", VI: "Biểu mẫu Medicare đã điền đã được tải xuống!" },
  "prepare.prefillError": { EN: "Could not generate the pre-filled form. Please try again.", AR: "تعذر إنشاء النموذج المعبأ. يرجى المحاولة مرة أخرى.", NP: "पूर्व-भरिएको फारम बनाउन सकिएन। कृपया फेरि प्रयास गर्नुहोस्।", IT: "Impossibile generare il modulo. Riprova.", VI: "Không thể tạo biểu mẫu. Vui lòng thử lại." },
  ...
  // Form filling UI
  "form.formAssistant": { EN: "Form Assistant", AR: "مساعد النموذج", NP: "फारम सहायक", IT: "Assistente Modulo", VI: "Trợ lý Biểu mẫu" },
  "form.dspTitle": { EN: "Disability Support Pension", AR: "معاش دعم الإعاقة", NP: "अपाङ्गता सहायता पेन्सन", IT: "Pensione di Sostegno alla Disabilità", VI: "Trợ cấp Hỗ trợ Người khuyết tật" },
  "form.allComplete": { EN: "✅ All questions answered — your form is ready!", AR: "✅ تمت الإجابة على جميع الأسئلة — نموذجك جاهز!", NP: "✅ सबै प्रश्नहरूको जवाफ दिइयो — तपाईंको फारम तयार छ!", IT: "✅ Tutte le domande completate — il tuo modulo è pronto!", VI: "✅ Đã trả lời tất cả câu hỏi — biểu mẫu của bạn đã sẵn sàng!" },
  "form.questionsOf": { EN: "of", AR: "من", NP: "मध्ये", IT: "di", VI: "trên" },
  "form.questionsComplete": { EN: "questions complete", AR: "أسئلة مكتملة", NP: "प्रश्नहरू पूरा", IT: "domande completate", VI: "câu hỏi hoàn thành" },
  "form.thinking": { EN: "Luma is thinking…", AR: "لوما تفكر…", NP: "Luma सोच्दै छ…", IT: "Luma sta pensando…", VI: "Luma đang suy nghĩ…" },
  "form.placeholder": { EN: "Type your answer…", AR: "اكتب إجابتك…", NP: "तपाईंको जवाफ टाइप गर्नुहोस्…", IT: "Scrivi la tua risposta…", VI: "Nhập câu trả lời…" },
  "form.datePlaceholder": { EN: "DD/MM/YYYY", AR: "DD/MM/YYYY", NP: "DD/MM/YYYY", IT: "GG/MM/AAAA", VI: "DD/MM/YYYY" },
  "form.send": { EN: "Send", AR: "إرسال", NP: "पठाउनुहोस्", IT: "Invia", VI: "Gửi" },
  "form.saveAndContinue": { EN: "💾 Save & continue later", AR: "💾 حفظ والمتابعة لاحقاً", NP: "💾 सुरक्षित गर्नुहोस् र पछि जारी राख्नुहोस्", IT: "💾 Salva e continua dopo", VI: "💾 Lưu & tiếp tục sau" },
  "form.undoLast": { EN: "↩ Undo last answer", AR: "↩ تراجع عن الإجابة الأخيرة", NP: "↩ अन्तिम जवाफ फिर्ता गर्नुहोस्", IT: "↩ Annulla ultima risposta", VI: "↩ Hoàn tác câu trả lời cuối" },
  "form.session": { EN: "Session", AR: "الجلسة", NP: "सत्र", IT: "Sessione", VI: "Phiên" },
  "form.privacy": { EN: "🔒 Saved on your device only · Not sent anywhere", AR: "🔒 محفوظ على جهازك فقط · لا يتم إرساله لأي مكان", NP: "🔒 तपाईंको उपकरणमा मात्र सुरक्षित · कतै पठाइँदैन", IT: "🔒 Salvato solo sul tuo dispositivo · Non inviato da nessuna parte", VI: "🔒 Chỉ lưu trên thiết bị của bạn · Không gửi đi đâu" },
  "form.stopRecording": { EN: "Stop recording", AR: "إيقاف التسجيل", NP: "रेकर्डिङ बन्द गर्नुहोस्", IT: "Interrompi registrazione", VI: "Dừng ghi âm" },
  "form.voiceInput": { EN: "Voice input", AR: "إدخال صوتي", NP: "आवाज इनपुट", IT: "Input vocale", VI: "Nhập giọng nói" },
  "form.mute": { EN: "Mute", AR: "كتم الصوت", NP: "म्यूट", IT: "Disattiva audio", VI: "Tắt tiếng" },
  "form.unmute": { EN: "Unmute", AR: "إلغاء كتم الصوت", NP: "अनम्यूट", IT: "Attiva audio", VI: "Bật tiếng" },
  "form.downloadPdf": { EN: "📥 Download PDF", AR: "📥 تحميل PDF", NP: "📥 PDF डाउनलोड गर्नुहोस्", IT: "📥 Scarica PDF", VI: "📥 Tải PDF" },
  "form.generating": { EN: "⏳ Generating…", AR: "⏳ جاري التجهيز…", NP: "⏳ उत्पन्न गर्दै…", IT: "⏳ Generazione in corso…", VI: "⏳ Đang tạo…" },
  "form.back": { EN: "← Back", AR: "← رجوع", NP: "← पछाडि", IT: "← Indietro", VI: "← Quay lại" },
  "form.prefilledBanner": { EN: "📋 Pre-filled from your documents:", AR: "📋 تم التعبئة المسبقة من مستنداتك:", NP: "📋 तपाईंको कागजातहरूबाट पूर्व-भरिएको:", IT: "📋 Precompilato dai tuoi documenti:", VI: "📋 Đã điền sẵn từ tài liệu của bạn:" },
